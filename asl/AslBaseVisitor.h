...
public:
  ...
  virtual antlrcpp::Any visitArrayAccessLExpr(AslParser::ArrayAccessLExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitArrayAccessExpr(AslParser::ArrayAccessExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFuncExpr(AslParser::FuncExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitUnaryArithmetic(AslParser::UnaryArithmeticContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitUnaryLogical(AslParser::UnaryLogicalContext *ctx) override {
    return visitChildren(ctx);
  }
