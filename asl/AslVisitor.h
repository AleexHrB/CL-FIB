...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitArrayAccessLExpr(AslParser::ArrayAccessLExprContext *context) = 0;

    virtual antlrcpp::Any visitArrayAccessExpr(AslParser::ArrayAccessExprContext *context) = 0;

    virtual antlrcpp::Any visitFuncExpr(AslParser::FuncExprContext *context) = 0;
    ...
    virtual antlrcpp::Any visitUnaryArithmetic(AslParser::UnaryArithmeticContext *context) = 0;

    virtual antlrcpp::Any visitUnaryLogical(AslParser::UnaryLogicalContext *context) = 0;
